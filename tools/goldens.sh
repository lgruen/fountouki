...
scenes=(picker phonics phonics-miss phonics-miss-igloo phonics-done patterns patterns-emoji patterns-unit patterns-hard patterns-levelup patterns-done tracing tracing-watch tracing-two-stroke tracing-reward tracing-grade tracing-done parent-patterns parent-phonics parent-tracing)
# label width height
resolutions=(
