...
scenes=(picker phonics phonics-miss phonics-miss-igloo phonics-done patterns patterns-emoji patterns-numbers patterns-unit patterns-hard patterns-levelup patterns-done tracing tracing-watch tracing-two-stroke tracing-reward tracing-build tracing-grade tracing-done tracing-housewarming singback singback-ready singback-input singback-miss singback-reward singback-finale clock clock-routine clock-clock clock-halfpast clock-reward clock-finale compare compare-read compare-teens compare-fewer compare-judge compare-reward compare-reveal compare-finale counting counting-teens counting-done parent-patterns parent-phonics parent-tracing parent-singback parent-clock parent-compare)
# label width height
resolutions=(
