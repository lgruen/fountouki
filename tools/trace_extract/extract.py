...
ROUTES = {
    ...
    # Start at the bowl's true top-right corner (like a/d/q) — a lower start
    # waypoint let end_ext ray the start dot down below the corner.
    "g": [[(0.86, 1.0), (0.45, 1.0), (0.03, 0.75), (0.45, 0.5), (0.85, 0.8),
    ...
    "p": [[(0.25, 0.98), (0.05, 0.02), (0.15, 0.45), (0.55, 0.88), (0.7, 0.4),
           (1.0, 0.62)]],
    "q": [[(0.88, 0.95), (0.4, 1.0), (0.03, 0.75), (0.45, 0.5), (0.8, 0.8),
