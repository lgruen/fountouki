...
/// Warm honey ring around sequence/choice cells so each white tile reads as a
/// distinct rectangle against the near-white bar (they were near-invisible).
/// Sunnier than the old greyish taupe — friendly without fighting cell content.
pub const CELL_BORDER: Color = hex(0xe3b96a);
...
pub const CONCRETE_WET: Color = hex(0x918b80); // fresh pour
